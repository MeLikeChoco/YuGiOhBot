    ...
    public class YuGiOhRepository
    {
        ...
        public YuGiOhRepository(IYuGiOhRepositoryConfiguration config)
        {
            ...
            FluentMapper.Initialize(config =>
            {
                ...
                DommelMapper.SetKeyPropertyResolver(resolver);
        ...
        public async Task<IEnumerable<string>> GetCardsAsync(string name)
        {
            ...
            using (var connection = _config.GetYuGiOhDbConnection())
            {
                ...
                var cards = await connection.QueryAsync<string>(
                    "select name from cards where lower(name) like '@Name' and lower(realname) ~ @name", new { name });
